...
> **Note**
> 
> - <span style="color:blue"> 8-bit tensor cores are not supported on the CPU. bitsandbytes can be run on 8-bit tensor core-supported hardware, which are Turing and Ampere GPUs (RTX 10s, RTX 20s, RTX 30s, RTX 40s, A40-A100, T4+). </span>
