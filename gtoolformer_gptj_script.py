from code.Dataset_Loader import Dataset_Loader
from code.Method_Graph_Toolformer import Method_Graph_Toolformer
from code.Method_Graph_Toolformer_GPTJ import Method_Graph_Toolformer_GPTJ
from code.Result_Saver import Result_Saver
from code.Result_Loader import Result_Loader
    ...
    for reasoning_task in task_data_dict:
        for dataset_name in task_data_dict[reasoning_task]:
            ...
            if 1:
                ...
                data_obj = Dataset_Loader('{} prompt: {}'.format(reasoning_task, dataset_name), '')
                data_obj.batch_size = batch_size
                data_obj.random_seed = random_seed
                data_obj.dataset_source_folder_path = './data/{}/'.format(reasoning_task)
